...
from app.routers import grade, sof, manuscript, prisma_check, stubs, meta, fulltext_screen, extract, rob, pubias
...
app.include_router(pubias.router, prefix="/api/v1/pubias", tags=["pubias"])
